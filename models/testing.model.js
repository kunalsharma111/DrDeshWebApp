...
let visitSchemaa = new mongoose.Schema({
    savedon: Date,
    savedby: String,
    visit: Date,
...
mongoose.model('MVMM', visitSchemaa);
let masterptSchemaa = new mongoose.Schema({
...
mongoose.model('MasterPatientt', masterptSchemaa);
